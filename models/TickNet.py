...
def build_SpatialTickNet(num_classes, typesize='basic', cifar=False, cf_index=0):
    ...
    small_cf = [
        ...
        [[256], [128, 64], [128, 256, 512, 256], [128, 64, 128, 256], [512]],
        [[256], [128, 64], [128, 256, 512, 256, 128], [64, 128, 256], [512]],
        [[256], [128, 64, 128], [256, 512, 256], [128, 64, 128, 256], [512]],  # best
        [[256], [128, 64, 128], [256, 512, 256, 128], [64, 128, 256], [512]],
    ]
    large_cf = [
        [[256], [128, 64], [128, 256, 512, 256, 128, 64, 128, 256], [512, 256, 128, 64, 128, 256], [512]], # origin
        [[256, 128], [64, 128, 256, 512], [256, 128, 64, 128, 256, 512], [256, 128, 64, 128, 256], [512]], # 64,42
    ]
    channel_options = {
