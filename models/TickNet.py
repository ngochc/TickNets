...
def build_SpatialTickNet(num_classes, typesize='basic', cifar=False, cf_index=0):
    ...
    small_cf = [
        ...
        [[256], [128, 64], [128, 256, 512, 256], [128, 64, 128, 256], [512]], #r4 GMac > 2.1 -> config 11:
        ...
        [[256], [128, 64, 128], [256, 512, 256], [128, 64, 128, 256], [512]], #r3 GMac > 2.4 -> Current Best FLOP 1.21 (67.05)
        [[256], [128, 64, 128], [256, 512, 256, 128], [64, 128, 256], [512]], #r3 GMac > 2.4 -> config 17:
        ...
        [[256], [128, 64, 128, 256, 512, 256, 128], [64, 128], [256], [512]], #r1 FLOP > 2
        [[256], [128, 64, 128, 256, 512, 256, 128, 64], [128], [256], [512]], #r1 FLOP > 2
        [[256, 128], [64], [128], [256, 512, 256, 128, 64, 128, 256], [512]], #r3 GMac > 2.4 -> config 35:
        ...
        [[256, 128], [64], [128, 256, 512, 256, 128, 64], [128, 256], [512]], #r2 GMac > 3
        [[256, 128], [64], [128, 256, 512, 256, 128, 64, 128], [256], [512]], #r2 GMac > 3
        [[256, 128], [64, 128], [256], [512, 256, 128, 64, 128, 256], [512]], #r3 GMac > 2.4 -> config 42:
        [[256, 128], [64, 128], [256, 512], [256, 128, 64, 128, 256], [512]], #r2 GMac > 3
        [[256, 128], [64, 128], [256, 512, 256], [128, 64, 128, 256], [512]], #r2 GMac > 3
        [[256, 128], [64, 128], [256, 512, 256, 128], [64, 128, 256], [512]], #r2 GMac > 3
        [[256, 128], [64, 128], [256, 512, 256, 128, 64], [128, 256], [512]], #r2 GMac > 3
    ...
    large_cf = [
        ...
        [[256], [128, 64], [128, 256, 512, 256, 128, 64, 128, 256, 512, 256, 128, 64], [128, 256], [512]],# r1 FLOPs > 1.5
        [[256], [128, 64], [128, 256, 512, 256, 128, 64, 128, 256, 512, 256, 128, 64, 128], [256], [512]],# r1 FLOPs > 1.5
        [[256, 128], [64, 128, 256, 512], [256, 128, 64, 128, 256, 512], [256, 128, 64, 128, 256], [512]] # config: 27 -> % (200e)
    ]
    channel_options = {
